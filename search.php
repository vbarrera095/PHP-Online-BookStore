...
// Check if search key is set and not empty
if (!isset($_GET['key']) || empty($_GET['key'])) {
	// Redirect to index.php if search key is not provided
...
// Include book helper function
include "php/func-book.php";
// Get search results based on the key
$books = search_books($conn, $key);

// Include author helper function
include "php/func-author.php";
// Get all authors
$authors = get_all_author($conn);

// Include category helper function
...
<body>
	<div class="container">
		...
		<div class="d-flex pt-3">
			...
			<?php }else{ ?>
				<!-- If books found, display them -->
				<div class="pdf-list d-flex flex-wrap">
					<?php foreach ($books as $book) { ?>
						<div class="card m-1">
							<img src="images/<?=$book['cover']?>" class="card-img-top">
							<div class="card-body">
								...
								<!-- Links to open and download the book -->
